...
cfg.assets.poseModel = fullfile(projectRoot, 'assets', 'game', ...
    'models', 'movenet-single-lightning.tflite');
cfg.assets.windowsTiming = fullfile(projectRoot, 'assets', 'game', ...
    'runtime', 'windows', 'MatlabHiTiming.dll');
end

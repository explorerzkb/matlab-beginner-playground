...
s=createPoseState(); s.player(2).valid=true; s.player(2).lastTime=10;
t=poseTelemetry(t,'bound',10,s);
t=poseTelemetry(t,'bound',10.1,s);
assert(isequal(t.boundUpdates,[0 1]),'Bound player rate counted a stale/other ROI');

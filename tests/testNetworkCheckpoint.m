...
state.players(1).pos = [55.2, 1];
state.players(2).pos = [56.2, 1];
...
state.players(1).pos = [checkbox(1) + 0.45, checkbox(2)];
state.players(2).pos = [checkbox(1) + 1.0, checkbox(2)];
state = stepLevel(state, world, cfg, 0.1);
...
state.players(1).pos = [60, 1];
state.players(2).pos = [61, 1];

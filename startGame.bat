...
if not defined MATLAB_EXE (
    echo MATLAB R2025b was not found. Open MATLAB and run startGame.m manually.
    pause
    exit /b 1
)
"%MATLAB_EXE%" -sd "%PROJECT_DIR%" -r "try, startGame; catch err, disp(getReport(err,'extended')); end"
endlocal

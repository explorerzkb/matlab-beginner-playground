...
艾比特导航、任务卡和 `Lucy 河`目前没有可直接复用的本地视觉材料。破防水已由用户指定唯一视觉源，原图直接保存在正式运行时目录 [`../game/images/items/tropical-iced-tea.jpg`](../game/images/items/tropical-iced-tea.jpg)，来源、哈希与使用边界见同目录 README；不得从本参考区或历史区另找替代图片。

...
The unmodified model is accompanied by the full [Apache 2.0 license](LICENSE-2.0.txt). The model hash above identifies the upstream file; the separate shape-fixing utility only applies to the optional MultiPose benchmark.

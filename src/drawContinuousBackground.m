...
signX=deck(1)-3.7;
plot(ax,[signX signX],[1 3.9],'-','Color',[.34 .37 .32],'LineWidth',2);
rectangle(ax,'Position',[signX-1.9 3.65 3.8 1.35], ...
    'Curvature',.06,'FaceColor',[.31 .39 .30], ...
    'EdgeColor',[.57 .60 .47],'LineWidth',.8);
text(ax,signX-.23,4.58,'大跳上桥', ...
    'FontName',cfg.render.fontName,'FontSize',10,'FontWeight','bold', ...
    'HorizontalAlignment','center','Color',[.94 .92 .79]);
text(ax,signX,4.02,'先喝冰红茶', ...
    'FontName',cfg.render.fontName,'FontSize',8, ...
    'HorizontalAlignment','center','Color',[.85 .86 .73]);
plot(ax,signX+[1.23 1.62 1.62 1.33 1.62],[4.38 4.77 4.48 4.77 4.77], ...
    '-','Color',[.94 .92 .79],'LineWidth',1.4);
end
